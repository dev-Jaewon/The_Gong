...
BUILD_JAR=$(ls /home/ubuntu/action/backend/build/libs/MainProject-0.0.1-SNAPSHOT.jar)
...
DEPLOY_PATH=/home/ubuntu/action/backend/
...
sudo nohup java -jar $DEPLOY_JAR >> /home/ubuntu/action/backend/deploy.log 2>/home/ubuntu/action/backend/deploy_err.log &