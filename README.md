...
|                                            <p align="left">- 로그인 등 인증 처리<br/>- 메인 페이지<br/> - 배포(S3)</p>                                             |                    <p align="left">- 화상회의(WebRTC)<br/>채팅(socket) <br/></p>                    |                 <p align="left">- 화상회의(WebRTC)<br/></p>                  |                                                     <p align="left">- 화상회의(WebRTC)<br/>- AWS(EC2,RDS)<br/> 배포환경 구축</p>                                                     |                                                     <p align="left">- 채팅(socket)<br/>- OAuth</p>                                                     |                                 <p align="left">- 유저,룸,태그 CRUD 기능 <br/>- 시큐리티 <br/> - AWS(EC2,RDS)<br/> 배포환경 구축</p>                                  |
